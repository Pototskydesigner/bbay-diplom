...
?>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		...
		<input type="hidden" name="sender_subscription" value="add">
			<label>
			<input type="email"  placeholder="Enter your Email adress" required name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
		...
		<div class="bx_subscribe_submit_container">
			<button <?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
		</div>
		</div>
